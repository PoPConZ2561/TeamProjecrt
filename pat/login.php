    ...
    <main class="flex flex-grow flex-col items-center justify-center w-full bg-gray-200">
        <div class="flex flex-row w-[60%] h-[500px] bg-white rounded-lg shadow-md mt-10">
            <div class="flex w-[55%] h-full border-r">
                <img src="undraw_people_ka7y.svg" class="w-[80%] mx-auto my-auto object-cover">
            </div>
            <div class="flex flex-col w-[45%] p-6 gap-2">
                <h1 class="register_text">เข้าสู่ระบบ</h1>
                <form action="#" method="post" class="flex flex-col gap-4">
                    <input type="email" name="email" placeholder="อีเมล" class="pl-2 w-full h-[40px] border rounded-sm" required>
                    <input type="password" name="password" placeholder="รหัสผ่าน" class="pl-2 w-full h-[40px] border rounded-sm" required>
                    <button type="submit" class="login_text pl-2 w-full h-[40px] bg-blue-950 rounded-sm">ยืนยัน</button>
                </form>
